			...
			{#if currentTrack}
				...
				<div class="flex items-center justify-center gap-6 mb-8 w-full">
					<button
						...
						class="p-3 neo-button bg-white text-black hover:bg-gray-100 disabled:opacity-50"
					...
					<button
						...
						disabled={!isReady}
						class="p-4 neo-button bg-yellow-400 text-black hover:translate-y-1 hover:shadow-none disabled:opacity-50 rounded-full border-4 border-black shadow-neo"
